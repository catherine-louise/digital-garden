...
>*Wright had lost his home in the Oakland firestorm of 1991, and has said that the original purpose of The Sims was to simulate the building and designing of houses. Indeed, the game maintains a lasting obsession with real estate. To play a family one must buy a home, and a home in The Sims is like a zen garden: obsessively tended to, an object of constant maintenance and contemplation.* 

This is true. But is this not also the case of real homes? 

> A home in _The Sims_ lacks the usual animating forces of family life. Intimacy between relatives is measured in points, increasing or decreasing without any given injury or kindness settling into a memory. A _Sims_ home is not a haven or stage for emotions; it is only a system that challenges players to maintain its various parts. The game’s characters therefore never seem to experience the ongoing dramas of domesticity—neither its tender feelings nor its threat of betrayal, violence, resentment, dependency, scandal, and mutual ruination. 
> 
> This is, ultimately, less a narrative project than an ecological one. _The Sims_ is about holistic relations, the quick and at times perilous responsiveness of one part of the whole to another. 
  
Yes, I agree that this is an “ecological project” and not a “narrative one,” but families themselves are systems that have to be maintained, economically, personally, socially, etc… and for the maintenance of these systems to have meaning, we need to invoke a narrative about who we are and what we do. 


> The fate of any Sim depends on a player’s ability to execute such formulas. “To play the game means to play the code of the game,” Galloway writes. “To win means to know the system.” He calls this a matter of “life lived as an algorithm.” One helps a Sim by employing an algorithm, which is often the same thing as internalizing it. Far from providing a nostalgic refuge from the contemporary Internet, in other words, _The Sims_ taps into one of the Web’s most foundational assumptions: that the processes of thinking and producing can be reduced to a series of commands. **The user, in this view, becomes more creative as she becomes more machine-like. The rules allow her to manufacture possibilities; she is less an author employing technology for her own ends than an emitter of inputs, a conscript of the machine’s algorithmic logic**. _The Sims_ taps into one of the Web’s most foundational assumptions: that the processes of thinking and producing can be reduced to a series of commands. The user, in this view, becomes more creative as she becomes more machine-like. The rules allow her to manufacture possibilities; she is less an author employing technology for her own ends than an emitter of inputs, a conscript of the machine’s algorithmic logic.

“Which is often the same thing” is doing _so much work_ here that’s glossed over.  

“Far from providing a nostalgic refuge from the contemporary internet” - assuming that the Sims is purely a nostalgic project and not engaging with the fact that the Sims 4 exists and is thriving and alive and well (something at least the _Paris Review_ article does as well - [[Real Play - Devon Brody]]).

“In this view” - in whose views? “That the processes of thinking and producing can be reduced to a series of commands.” What does this mean? As applied to the sims, the user taps and clicks commands (“execute such formulas”) but is just a conscript of the machine’s logic. I think this view really, _really_ takes away agency from players who use this game in ways opposite to what the designers intend. 

> A notable feature of algorithms is that they cannot draw their own connections to make sense of seemingly contradictory events. On _The Sims_ you can caress a beloved and then immediately antagonize her, and these two acts will cancel each other out. A quantity of affection has been given and then taken away, but there are no ligaments of memory or sense between the moments, no way in which one act might deepen another or throw it into question. It is only narrative that can do this: allow us to interpret contradiction by appealing to a higher level of sense, recoup absurdity and give us the structure we need to bear it. 

  
Hu’s main critique of the Sims is that it is not a narrative game, that it presents a series of clicks and choices about what to click, choices which are “seemingly contradictory,” and then leaves the contradictions created by the clicks unresolved. 
